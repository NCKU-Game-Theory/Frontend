    ...
    <v-app>
        ...
        <v-main>
            ...
            <v-container v-else>
                ...
                <v-card title = '你的名字' class = ma-3>
                    <template #text>
                        <v-text-field v-model = username></v-text-field>
                    </template>
                </v-card>

                <v-card title = '你的數字' class = ma-3>
                    <template #text>
                ...
                <v-hover>
                    <template #default = '{isHovering, props}'>
                        <v-card @click = submit title = 送出 v-ripple class = 'ma-3 text-center' v-bind = props :color = 'isHovering ? `orange` : undefined' />
                    </template>
                </v-hover>
            </v-container>
